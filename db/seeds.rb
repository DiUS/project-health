...
Rating.create(span: project1_span1, indicator: ind1, score: 1)
Rating.create(span: project1_span1, indicator: ind1, score: 2)
Rating.create(span: project1_span1, indicator: ind1, score: 2)

Rating.create(span: project1_span1, indicator: ind2, score: 4)
Rating.create(span: project1_span1, indicator: ind2, score: 2)
Rating.create(span: project1_span1, indicator: ind2, score: 1)

Rating.create(span: project1_span1, indicator: ind3, score: 2)
Rating.create(span: project1_span1, indicator: ind3, score: 3)


Rating.create(span: project1_span2, indicator: ind1, score: 1)
Rating.create(span: project1_span2, indicator: ind1, score: 2)
Rating.create(span: project1_span2, indicator: ind1, score: 1)
Rating.create(span: project1_span2, indicator: ind1, score: 1)
